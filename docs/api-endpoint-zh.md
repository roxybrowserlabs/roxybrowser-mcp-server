...
```Json
{
    ...
    "data": {
        ...
        "rows": [
            {
                "id": 3,                                                        // 账号库id
                "platformUrl": "https://www.tiktok.com/",                       // 平台账号url
        ...
        "rows": [
             {
                ...
                "coreType": "Chrome",                                   // 浏览器内核类型，Chrome/Firefox, str类型
        ...
        "rows": [
             {
                ...
                "windowPlatformList": [{
                    "id": 0,                                            // 平台账号id，int类型，非必传，通过平台账号列表接口【/account/list】获取
...
```Json
{
    ...
    "projectId":1,                                              // 项目ID, int类型, 非必传，通过团队项目接口【/browser/workspace】获取
    "proxyInfo": {
        "moduleId": 0,                                          // 代理id，int类型，0 为不使用，非必传，通过代理列表接口【/proxy/list】获取
        "proxyMethod": "custom",                                // 代理方式，枚举值：手动填写：custom，选择代理 IP：choose，str类型
    ...
    "fingerInfo": {
        ...
        "forbiddenPictureSize": 0,                              // 图片加载大小阈值。当 forbidImage 为 false 时，设置 forbiddenPictureSize = 0 将禁用所有图片加载。默认 0。
        ...
        "openWorkbench": 1,                                     // 是否打开工作台, 关闭: 0，开启: 1，跟随软件设置: 2，int类型, 非必传, 默认1
        ...
        "openBattery": false,                                   // 电池 API 模拟总开关，布尔类型，非必传，默认 false
        "openCharging": false,                                  // 开启电池模拟时的充电状态，布尔类型，非必传，默认 false
        "chargingTime": "",                                     // 距离充满的秒数（纯数字字符串，不带单位后缀），str，非必传
        "dischargingTime": "",                                  // 距离耗尽的秒数（纯数字字符串，不带单位后缀），str，非必传
        "level": "",                                            // 电量，0–1，str，非必传
        "openNetwork": false,                                   // Network Information API 模拟总开关，布尔类型，非必传，默认 false
        "networkType": "wifi",                                  // 连接类型：wifi、cellular、ethernet、bluetooth、wimax、other、unknown，str，非必传
        "networkSpeed": "4g",                                   // 有效连接类型：slow-2G、2g、3g、4g（对应下行/有效类型；networkType 为 cellular 时，slow-2G 会规范为 2G 作为底层 nettype），str，非必传
        "downloadSpeed": "",                                    // 下行速率（Mbps），str，非必传
        "maxDownloadSpeed": "",                                 // 最大下行速率（Mbps），str，非必传
        "latency": "",                                          // 往返时延（ms），str 或 number，非必传
        "saveFlowMode": false,                                  // 省流 / Save-Data 模式，布尔类型，非必传，默认 false
        "openBluetooth": false,                                 // 蓝牙模拟总开关，布尔类型，非必传，默认 false
        "bluetoothAdapter": false,                              // 是否模拟存在蓝牙适配器，布尔类型，非必传，默认 false
        "blockDomainList": "",                                  // 网址访问黑名单, 多个域名使用 \n 分割
        "allowDomainList": ""                                   // 网址访问白名单, 多个域名使用 \n 分割
    }
}
```
...
<img src="https://roxy-web.oss-cn-beijing.aliyuncs.com/faq/image/windowRatioPosition.png" alt="windowRatioPosition 参数" style="width: 80%; height: auto;" />
</div>
...
{   
    ...
    "forceOpen": false,  // 是否强制打开
    "headless": false    // 是否以无头模式打开
}
...
{
    "dirIds": ["dc1ed4d","2e18ce","yy67yegk"],    // 浏览器窗口id，List类型，必传
    "type": "all",                                // 清除类型，str类型，非必传，默认 all。partial：清除本地缓存（保留插件）；all：清除本地缓存；cloud：清除本地及云端全部缓存
    "workspaceId": 1                              // 团队id，int类型，type 为 cloud 时必传，通过团队项目接口【/browser/workspace】获取
}
```
...
```Json
{
    ...
    "data": {
        ...
        "rows": [
            {
                "id": 1,                      // 代理库 id，int
                "checkStatus": 0,             // 检测状态，int
                "checkChannel": "",           // 检测渠道地址，str
                "checkChannelValue": "",      // 检测渠道值，str
                "lastIp": "",                 // 最后 IP，str
                "lastCountry": "",            // 最后国家，str
                "lastState": "",              // 最后州，str
                "lastCity": "",               // 最后城市，str
                "ipType": "",                 // IP 类型，str
                "protocol": "",               // 协议，str
                "host": "",                   // 主机，str
                "port": "",                   // 端口，str
                "proxyPassword": "",          // 代理密码，str
                "proxyUserName": "",          // 代理用户名，str
                "refreshUrl": "",             // 刷新 URL，str
                "remark": "",                 // 备注，str
                "checkTime": "",              // 检测时间，str
                "createTime": "",             // 创建时间，str
                "updateTime": "",             // 更新时间，str
...
```Json
{
    "workspaceId": 1,              // 团队 id，int 类型，必传，通过团队项目接口【/browser/workspace】获取
    "type": "available_list",      // 查询类型，str 类型，非必传
    "page_index": 1,               // 分页索引，int/string 类型，非必传，默认 1
    "page_size": 100,              // 分页条数，int/string 类型，非必传，默认 15
    "orderName": "lastCountry",    // 排序字段，str 类型，非必传
    "orderType": "asc",            // 排序方向，可选值：asc、desc，非必传
    "proxyType": "0",              // 代理来源，str 类型，非必传，0：用户添加代理，1：代理商店代理
    "proxyBindStatus": "1",        // 绑定状态，str 类型，非必传，不传或为空表示全部
    "proxyAutoRenew": "1"          // 自动续费状态，str 类型，非必传，不传或为空表示全部
}
```
        ...
        "rows": [
            {
                "id": 395935,                                      // 代理 ID
                "userId": 37245,                                   // 用户 ID
                "workspaceId": 19744,                               // 团队 ID
                "canBandwidthUpgrade": true,                        // 是否可升级带宽
                "proxyProviderId": 1,                               // 代理提供商 ID
                "orderNo": "",                                     // 订单号
                "orderStatus": 1,                                   // 订单状态
                "ipType": "IPV4",                                  // IP 类型
                "host": "gate12.rola.vip",                         // 代理主机
                "protocol": "SOCKS5",                              // 代理协议
                "country": "",                                     // 国家筛选/来源值
                "lastIp": "",                                      // 最近 IP
                "port": "2000",                                    // 代理端口
                "proxyUserName": "QWERFGKL_8998811-country-us",    // 代理用户名
                "proxyPassword": "Q1",                             // 代理密码
                "proxyCheckChannel": "http://iprust.io/ip.json",    // 代理检测渠道
                "remark": "4561",                                  // 备注
                "lastCountry": "",                                 // 最近检测国家
                "lastState": "",                                   // 最近检测州/省
                "lastCity": "",                                    // 最近检测城市
                "checkStatus": 2,                                   // 最近检测状态
                "proxyExpireStatus": 1,                             // 过期状态
                "checkTime": "2026-04-28 15:14:43",                 // 最近检测时间
                "renewalTime": "",                                 // 续费时间
                "createTime": "2026-03-25 12:09:54",                // 创建时间
                "proxyMonths": 0,                                   // 代理月数
                "updateTime": "2026-04-28 15:14:48",                // 更新时间
                "expireDate": "2026-04-28 15:14:48",                // 过期时间
                "replaceStatus": 0,                                 // 更换状态
                "proxyProviderName": "",                           // 代理提供商名称
                "proxyType": 0,                                     // 代理来源类型
                "providerType": "",                                // 提供商类型
                "opName": "",                                      // 操作人名称
                "giftDays": 0,                                      // 赠送天数
                "autoRenew": 0,                                     // 自动续费状态
                "canRenew": false,                                  // 是否可续费
                "modelParam": "",                                  // 模型参数
                "refreshUrl": "",                                  // 刷新 URL
                "isDirect": false,                                  // 是否直连
                "badgeTypeDesc": "",                               // 标识类型描述
                "dataType": "proxyModule",                          // 数据来源，proxyModule：用户添加，buyProxy：代理商店
                "checkChannel": "http://iprust.io/ip.json",         // 检测渠道地址
                "checkChannelValue": "IPRust.io",                   // 检测渠道标签
                "isBind": true,                                     // 是否绑定窗口
                "bindCount": 2,                                     // 绑定窗口数量
                "bindList": [994, 992],                             // 绑定窗口列表
                "canRefund": false,                                 // 是否可退款
                "bandwidthSpeed": 10                                // 带宽速度
            }
        ]
    },
    "msg": "成功"
...
{   
    ...
    "host": "",                     // 代理主机 str, 必传
    "port": "",                     // 代理端口 str, 必传
    "proxyUserName": "",            // 代理账号 str
    "proxyPassword": "",            // 代理密码 str
    "refreshUrl": "",               // 刷新URL str
    "remark":"",                    // 备注
}
```
| 参数名称 | 必需项                                      | 参数类型 | 默认值 | 描述 |
...
{   
    ...
    "page_index": 1,     // 分页索引，int类型，非必传，默认1
    "page_size": 15,     // 分页条数，int类型，非必传，默认15
    "type":0             // 查询类型，int类型，非必传，默认0，0:查询所有，1:查询可用，
}
```
        ...
        "rows": [
            {
                ...
                "orderNo": "",                // 订单号
                "checkStatus": 1,             // 检测状态
                "proxyCheckChannel": "",      // 检测渠道地址
                "checkChannelValue": "",      // 检测渠道值
                "lastIp": "",                 // 最后 IP
                "lastCountry": "",            // 最后国家
                "lastState": "",              // 最后州
                "lastCity": "",               // 最后城市
                "proxyProviderName": "",      // 代理提供商名称
                "providerType": "",           // 代理提供商类型
                "ipType": "",                 // IP 类型
                "protocol": "",               // 协议
                "host": "",                   // 主机
                "port": "",                   // 端口
