<!-- Generated by scripts/generate-api-artifacts.mjs. Migrated 32/32 endpoints and 4/4 appendices. -->
...
<b style="font-size: 18px">GET /workspace/list</b>
...
| ---------------------------- | ------------------ | ------------------------------------- |
| code                         | int                | Status code, 0: Success, 500: Failure |
| data                         | object             | All workspaces returned by the API.   |
| data.total                   | int                | Total count                           |
| data.rows                    | List&lt;object&gt; | Workspace summaries                   |
| data.rows[].email            | string             | Account email                         |
| data.rows[].id               | int \| string      | Workspace ID                          |
| data.rows[].maxWindowCount   | int                | Maximum browser window count          |
| data.rows[].role             | int                | Workspace role                        |
| data.rows[].totalMemberCount | int                | Total member count                    |
| data.rows[].totalWindowCount | int                | Total browser window count            |
| data.rows[].useMemberCount   | int                | Used member count                     |
| data.rows[].useWindowCount   | int                | Used browser window count             |
| data.rows[].workspaceName    | string             | Workspace name                        |
| data.rows[].workspaceNo      | string             | Workspace number                      |
| msg                          | string             | Response message                      |
...
| data.rows[].id                            | int \| string      | Team ID                               |
...
<b style="font-size: 18px">POST /browser/workspace/select</b>
...
| Parameter   | Required | Type          | Default | Description                                        |
| ----------- | -------- | ------------- | ------- | -------------------------------------------------- |
| workspaceId | Yes      | int \| string | -       | Target workspace ID                                |
| force       | No       | boolean       | false   | Force switching even when browser windows are open |

#### Force behavior

When `force` is `false` or omitted, switching is rejected while browser windows are open. When `force` is `true`, the workspace is switched regardless of open browser windows.
...
<b style="font-size: 18px">GET /browser/workspace/active</b>
...
| ---------------------------------- | ------------------ | ------------------------------------- |
| code                               | int                | Status code, 0: Success, 500: Failure |
| data                               | object             | Team workspace returned by the API.   |
| data.id                            | int \| string      | Team ID                               |
| data.workspaceName                 | string             | Team name                             |
...
| useLatestCore                         | No       | 0 \| 1                                                                                                                                                                                                                                                                                                                                                                                                                                 | 0       | Whether the browser profile should always use the latest core version                       |
