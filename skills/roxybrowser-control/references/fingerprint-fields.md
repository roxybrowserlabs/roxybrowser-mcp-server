...
Both `roxy_profile_create` and `roxy_profile_update` accept `fingerInfo` as an object. The MCP tool schema intentionally does not expand these fields to keep common create/update calls focused.
