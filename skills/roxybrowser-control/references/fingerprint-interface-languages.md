# Fingerprint Interface Language Values

Use this file for exact `displayLanguage` values used by `fingerInfo`. Other appendix values live in [fingerprint-resolutions.md](fingerprint-resolutions.md), [fingerprint-languages.md](fingerprint-languages.md), and [fingerprint-timezones.md](fingerprint-timezones.md). Field meanings live in [fingerprint-fields.md](fingerprint-fields.md).

Source: user-provided RoxyBrowser API appendix attachment. Count from this file: 183 interface languages.

Use these in `displayLanguage` only when `isDisplayLanguageBaseIp` is `false`. The API docs call this the Appendix-Interface Language List.

## Interface Language Values
