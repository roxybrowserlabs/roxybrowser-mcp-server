...
export const COMMERCE_MCP_TOOLS: McpTool[] = [
  {
    ...
    handler: async (args, context) => formatCommerceAccounts(await context.commerce!.accounts.list(args)),
  },
  {
    ...
    handler: async (args, context) => formatCommerceAccount(await context.commerce!.accounts.get(args.id)),
  },
  {
    ...
    handler: async (args, context) => formatCommerceAccount(await context.commerce!.accounts.create(args as any)),
  },
  {
  ...
  },
  {
    ...
    inputSchema: objectSchema({ id: { type: 'string' }, force: { type: 'boolean' }, args: stringArray, headless: { type: 'boolean' } }, ['id']),
    handler: async (args, context) => {
      const opened = await context.commerce!.accounts.open(args.id, removeUndefined({ force: args.force, args: args.args, headless: args.headless }))
  ...
  },
  {
    ...
    handler: async (args, context) => JSON.stringify(await context.commerce!.proxies.get(args.id), null, 2),
  },
  {
  ...
  },
  {
    ...
    inputSchema: objectSchema({ id: { type: 'number' } }, ['id']),
    handler: async (args, context) => JSON.stringify(await context.commerce!.proxies.detect(args.id), null, 2),
  },
  {
    ...
    inputSchema: objectSchema({}),
    handler: async (_args, context) => JSON.stringify(await context.commerce!.proxies.detectChannels(), null, 2),
  },
  {
    ...
    handler: async (args, context) => formatPlatformAccounts(await context.commerce!.platformCredentials.list(args)),
  },
  {
