...
export const ROXY_CAPABILITIES = {
  ...
  "commerce.account.close": {
    operationId: "commerce.account.close",
    endpoint: "POST /browser/close",
    sinceRoxyBrowserVersion: ROXY_BROWSER_VERSION_3_0_0,
  },
  "commerce.account.delete": {
